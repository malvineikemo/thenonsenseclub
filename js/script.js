...
const config = {
    serverInfo: {
        ...
        serverName: "The Nonsense Club", /*Server name*/
        serverIp: "thenonsenseclub.xyz", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "957027875922542606" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    */
    ...
    adminTeamPage: {
        leaders: [
            ...
            {
                inGameName: "SebastianGP09",
                rank: "Manager",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "Banansplitt346",
                rank: "Moderator",
                skinUrlOrPathToFile: "",
                rankColor: ""
            }
    ...
    */
    contactPage: {
        email: "contact@thenonsenseclub.xyz"
    }
}
